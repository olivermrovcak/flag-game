...
function LevelSelect() {
  return (
    <div className=' overflow-x-hidden'>
        ...
        <div className='p-2 mt-7 ml-7 w-[40%] text-center rounded-xl bg-[#49BB84]'>
            <h1 className='font-extrabold text-white'>LEVELS</h1>
        </div>
        ...
        <div className='grid grid-cols-4 gap-6 p-7'>
            ...
            state = {{levelq: 1 }}
            >
            <div className='w-[50px] h-[50px] rounded-xl bg-[#49BB84] flex justify-center items-center' >
                <p className='text-white font-bold text-[25px]'>1</p>
            </div>
            </Link>
